...
@section('custom')
   ...
   <div class="col-md-9">
      ...
      <ul class="nav nav-tabs usernavbar">
         <li><a href="{{ route('user', ['username' => $user->username]) }}"><i class="glyphicon glyphicon-picture"></i> {{ t('Images Shared') }}</a></li>
         <li class="active"><a href="{{ route('users.favorites', ['username' => $user->username]) }}" class="active"><i class="glyphicon glyphicon-heart"></i> {{ t('Favorites') }}</a></li>
      </ul>
