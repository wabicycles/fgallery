                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0">
                                                        ...
                                                        <tr>
                                                            <td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                                <h1 style="color: #202020; display: block; font-family: Helvetica; font-size: 26px; font-style: normal; font-weight: bold; line-height: 200%; letter-spacing: normal; margin: 0; margin-bottom: 0; text-align: left">Welcome to {{ siteSettings('siteName') }}</h1>
                                                                <h2 style="color: #606060; display: block; font-family: Helvetica; font-size: 18px; font-style: italic; font-weight: normal; line-height: 110%; letter-spacing: normal; margin: 0; margin-bottom: 20px; text-align: left">Activation Email</h2>
                                                                <h3 style="color: #666; display: block; font-family: Helvetica; font-size: 16px; font-style: normal; font-weight: normal; line-height: 110%; letter-spacing: normal; margin: 0; margin-bottom: 9px; text-align: left">Thanks a lot <strong>{{ $fullname }}</strong> for registering with us.</h3>
                                                                <h3 style="color: #666; display: block; font-family: Helvetica; font-size: 16px; font-style: normal; font-weight: normal; line-height: 110%; letter-spacing: normal; margin: 0; margin-bottom: 9px; text-align: left">You have registered with username "<strong>{{ $username }}</strong>"</h3>
                                                                <p style="margin: 0; padding-bottom: 1em">To activate your account please click on this link <a href="{{ url('registration/activate/'.$username.'/'.$activationcode) }}" style="word-wrap: break-word; color: #505050; font-weight: normal; text-decoration: underline">Activate My Account</a></p>
                                                                <p style="margin: 0; padding-bottom: 0">Or Copy and paste this in browser {{ url('registration/activate/'.$username.'/'.$activationcode) }}</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0">
                                                        ...
                                                        <tr>
                                                            <td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; font-size:11px;color:#a9a9a9;padding-bottom:9px;text-align:center;padding-right:18px;padding-left:18px;padding-top:9px;">
                                                                ...
                                                                <p style="margin: 0; padding-bottom: 0">This is an activation email​</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
