    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="form-group">
                ...
                {!! Form::text('username', $user->username, ['class' => 'form-control input-lg', 'placeholder' => 'Username', 'disabled']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('fullname', 'Fullname') !!}
                {!! Form::text('fullname', $user->fullname, ['class' => 'form-control input-lg', 'placeholder' => 'Fullname']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('email', 'Email') !!}
                {!! Form::text('email', $user->email, ['class' => 'form-control input-lg', 'placeholder' => 'Email']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('about_me', 'About Me') !!}
                {!! Form::textarea('about_me', $user->about_me, ['class' => 'form-control input-lg', 'placeholder' => 'About Me']) !!}
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                {!! Form::text('blog_url', $user->blogurl, ['class' => 'form-control input-lg', 'placeholder' => 'Blog Url']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('fb_link', 'Facebook Link') !!}
                {!! Form::text('fb_link', $user->fb_link, ['class' => 'form-control input-lg', 'placeholder' => 'Facebook Link']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('tw_link', 'Twitter Link') !!}
                {!! Form::text('tw_link', $user->tw_link, ['class' => 'form-control input-lg', 'placeholder' => 'Twitter Link']) !!}
            </div>
            ...
            <div class="form-group">
                ...
                {!! Form::select('permission', ['user' => 'User','ban' => 'Ban', 'admin' => 'Admin'], $user->permission , array('class'=>'form-control input-lg'))  !!}
            </div>
            ...
            <div class="form-group">
                ...
                ( <i class="fa fa-info" data-toggle="tooltip" data-placement="top" data-original-title="Users details can't be restored after that"></i> )
            </div>
